...
import type { UpdateCalendarSettingsRequest, CalendarView } from '@/types';
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-900">Ustawienia kalendarza</h1>
                ...
                {isLoading ? (
                    <div className="flex items-center justify-center py-12">
                        ...
                        <span className="ml-3 text-gray-600">Ładowanie ustawień...</span>
                    </div>
                ) : (
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            ...
                                            <select
                                                name="defaultView"
                                                value={formData.defaultView ?? 'day'}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="time"
                                                name="defaultEndTime"
                                                value={formData.defaultEndTime ?? '20:00'}
                                                onChange={handleChange}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                        </div>
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-sm font-medium text-gray-900">Opcje wyświetlania</h3>
                                        <div className="space-y-3">
                                            <label className="flex items-center gap-3">
                                                <input
                                                    type="checkbox"
                                                    name="showWeekends"
                                                    checked={formData.showWeekends ?? false}
                                                    onChange={handleChange}
                                            ...
                                            <label className="flex items-center gap-3">
                                                <input
                                                    ...
                                                    checked={formData.showEmployeePhotos ?? true}
                                                    onChange={handleChange}
                                                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                                                />
                                                <span className="text-sm text-gray-700">
                                            ...
                                            <label className="flex items-center gap-3">
                                                <input
                                                    ...
                                                    checked={formData.showServiceColors ?? true}
                                                    onChange={handleChange}
                                                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                                                />
                                                <span className="text-sm text-gray-700">
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={formData.minAppointmentDuration ?? 15}
                                                onChange={handleChange}
                                                min={5}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={formData.maxAppointmentDuration ?? 480}
                                                onChange={handleChange}
                                                max={720}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={formData.minBookingAdvanceHours ?? 1}
                                                onChange={handleChange}
                                                min={0}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                            <p className="text-xs text-gray-500 mt-1">
                                                Ile godzin wcześniej można zarezerwować wizytę
                                            </p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                            ...
                                            <input
                                                ...
                                                value={formData.maxBookingAdvanceDays ?? 90}
                                                onChange={handleChange}
                                                min={1}
                                                max={365}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                            <p className="text-xs text-gray-500 mt-1">
                                                Ile dni w przyszłość można rezerwować
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <label className="flex items-center gap-3">
                                            ...
                                            />
                                            <span className="text-sm text-gray-700">
                                                Zezwalaj na rezerwacje w tym samym dniu
                                            </span>
                                        </label>
                                        <label className="flex items-center gap-3">
                                            <input
                                                ...
                                                checked={formData.allowOverlappingAppointments ?? false}
                                                onChange={handleChange}
                                                className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                                            />
                                            <span className="text-sm text-gray-700">
                                                Zezwalaj na nakładające się wizyty
                                            </span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <label className="flex items-center gap-3">
                                            <input
                                                ...
                                                checked={formData.secondReminderEnabled ?? false}
                                                onChange={handleChange}
                                                className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                                            />
                                            <span className="text-sm text-gray-700">
                                        ...
                                        {formData.secondReminderEnabled && (
                                            <div className="ml-7">
                                                <label className="block text-sm font-medium text-gray-700 mb-1">
                                                    Ile godzin przed wizytą (drugie)
                                                </label>
                                                <input
                                                    type="number"
                                                    name="secondReminderHoursBefore"
                                                    value={formData.secondReminderHoursBefore ?? 2}
                                                    onChange={handleChange}
                                                    min={1}
                                                    className="w-32 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                                />
                                    ...
                                    <div className="border-t pt-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-1">
                                                    Auto-oznaczenie jako nieobecny po (minuty)
                                                </label>
                                                <input
                                                    type="number"
                                                    name="autoMarkNoshowAfterMinutes"
                                                    value={formData.autoMarkNoshowAfterMinutes ?? 30}
                                                    onChange={handleChange}
                                                    min={5}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                                />
                                        ...
                                        <label className="flex items-center gap-3 mt-4">
                                            <input
                                                ...
                                                checked={formData.noshowPenaltyEnabled ?? false}
                                                onChange={handleChange}
                                                className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                                            />
                                            <span className="text-sm text-gray-700">
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={formData.cancellationDeadlineHours ?? 24}
                                                onChange={handleChange}
                                                min={0}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                            <p className="text-xs text-gray-500 mt-1">
                                                Ile godzin przed wizytą klient może anulować bez opłat
                                            </p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                            ...
                                            <input
                                                ...
                                                value={formData.rescheduleDeadlineHours ?? 24}
                                                onChange={handleChange}
                                                min={0}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            />
                                            <p className="text-xs text-gray-500 mt-1">
                                                Ile godzin przed wizytą klient może zmienić termin
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <label className="flex items-center gap-3">
                                        <input
                                            ...
                                            checked={formData.allowClientReschedule ?? true}
                                            onChange={handleChange}
                                            className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                                        />
                                        <span className="text-sm text-gray-700">
                                            Zezwalaj klientom na zmianę terminu online
                                        </span>
                                    </label>
                                </div>
                            )}
