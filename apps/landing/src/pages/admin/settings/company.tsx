                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    type="color"
                                                    name="primaryColor"
                                                    value={formData.primaryColor ?? '#25B4C1'}
                                                    onChange={handleChange}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={formData.invoicePaymentDays ?? 14}
                                                onChange={handleChange}
                                                min={1}
                                                max={90}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                ...
                                <div className="space-y-6">
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        ...
                                        <p className="text-sm text-blue-700 mt-1">
                                            Skonfiguruj ustawienia związane z przetwarzaniem danych osobowych
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={formData.gdprDataRetentionDays ?? 1095}
                                            onChange={handleChange}
                                            min={30}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                        />
                                        <p className="text-xs text-gray-500 mt-1">
                                            Domyślnie 1095 dni (3 lata). Dane klientów będą automatycznie
