...
import type { MessageTemplate, AutomaticMessageRule, Newsletter } from '@/types';
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex">
                ...
                <main className="flex-1 p-6">
                    {/* Header */}
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-gray-800">Komunikacja</h1>
                    ...
                    {stats && (
                        <div className="grid grid-cols-4 gap-4 mb-6">
                            ...
                            <div className="bg-white rounded-lg shadow p-4">
                                ...
                                <div className="text-sm text-gray-600">Dostarczonych</div>
                            </div>
                            <div className="bg-white rounded-lg shadow p-4">
                            ...
                            <div className="bg-white rounded-lg shadow p-4">
                                ...
                                <div className="text-sm text-gray-600">Koszt</div>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 'history' && (
                        <div className="bg-white rounded-lg shadow">
                            <SmsHistory logs={history.items} loading={historyLoading} />
                            ...
                            {history.total > history.limit && (
                                <div className="px-4 py-3 border-t border-gray-200 flex items-center justify-between">
                                    <div className="text-sm text-gray-600">
                                        ...
                                        {Math.ceil(history.total / history.limit)}
                                    </div>
                        ...
                        <div>
                            <div className="mb-6">
                                <p className="text-gray-600 mb-4">
                                    Automatyczne wiadomości są wysyłane na podstawie zdefiniowanych reguł,
                                    np. przypomnienia o wizytach, życzenia urodzinowe czy reaktywacja nieaktywnych klientów.
                                </p>
                    ...
                    {activeTab === 'newsletters' && (
                        <div>
                            <div className="mb-6">
                                <p className="text-gray-600 mb-4">
                                    Twórz i wysyłaj newslettery do wybranych grup klientów.
                                    Możesz filtrować odbiorców lub wybrać ich ręcznie.
                                </p>
                                <div className="flex justify-end">
                                    <button
                                        type="button"
                            ...
                            {newslettersLoading ? (
                                ...
                                <NewslettersList
                                    ...
                                    onDelete={async (id) => {
                                        if (window.confirm('Czy na pewno chcesz usunąć ten newsletter?')) {
                                            await deleteNewsletter.mutateAsync(id);
                                        }
                                    }}
                                    onSend={async (id) => {
                                        if (window.confirm('Czy na pewno chcesz wysłać ten newsletter?')) {
                                            await sendNewsletter.mutateAsync({ id });
                                        }
                                    }}
                                    onCancel={async (id) => {
                                        if (window.confirm('Czy na pewno chcesz anulować wysyłkę?')) {
                                            await cancelNewsletter.mutateAsync(id);
                                        }
                                    }}
                                    onViewRecipients={(id) => {
                                        // TODO: Open recipients modal
                                        console.log('View recipients for newsletter', id);
                                    }}
                                />
                            )}
                        </div>
