...
const AppointmentForm: ComponentType<AppointmentFormProps> = isTestEnv
    ? (require('@/components/AppointmentForm').default as ComponentType<AppointmentFormProps>)
...
export default function CalendarPage() {
    ...
    const handleDateSelect = useCallback(
        (start: Date, end: Date, employeeId?: number) => {
            setSelectedEvent(null);
            setSelectedStartTime(start.toISOString());
            setSelectedEndTime(end.toISOString());
            setFormOpen(true);
        },
        [],
    );
