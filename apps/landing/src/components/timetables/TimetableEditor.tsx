...
import type { Timetable, TimetableSlot, DayOfWeek } from '@/types';
                                ...
                                <>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updateSlot(day, 'startTime', e.target.value)
                                            }
                                        ...
                                        <input
                                            ...
                                            value={slot.endTime}
                                            onChange={(e) =>
                                                updateSlot(day, 'endTime', e.target.value)
                                            }
                                            className="px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                        />
                                    </div>
                                        ...
                                        {breakSlot && (
                                            <div className="flex items-center gap-2 ml-2">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        updateBreak(day, 'startTime', e.target.value)
                                                    }
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        updateBreak(day, 'endTime', e.target.value)
                                                    }
                                                    className="px-2 py-1 border border-orange-200 rounded text-sm focus:ring-2 focus:ring-orange-400"
                                                />
                                            </div>
