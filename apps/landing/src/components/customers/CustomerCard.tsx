        ...
        <div className="flex h-full flex-col bg-white">
            ...
            <div className="border-b bg-gradient-to-r from-cyan-600 to-cyan-700 p-6 text-white">
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            {customer.phone && (
                                <p className="text-cyan-100">{customer.phone}</p>
                            )}
                            {customer.email && (
                                <p className="text-sm text-cyan-200">{customer.email}</p>
                            )}
                        </div>
                    </div>
                    {onClose && (
                ...
                <div className="mt-4 flex gap-4 text-sm text-cyan-100">
                    ...
                    {customer.birthDate && (
                        <span>🎂 {new Date(customer.birthDate).toLocaleDateString('pl-PL')}</span>
                    )}
                </div>
