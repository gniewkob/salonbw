            ...
            <div className="flex-1 overflow-y-auto p-4">
                <div className="mb-4">
                    <div className="mb-2 flex items-center justify-between">
                        <h3 className="text-sm font-semibold text-gray-700">Grupy</h3>
                        {onCreateGroup && (
                            <button
                ...
                {/* Tags */}
                <div className="mb-4">
                    <h3 className="mb-2 text-sm font-semibold text-gray-700">Tagi</h3>
                            ...
                            <label className="flex items-center gap-2 text-sm">
                                <input
                                    ...
                                    onChange={(e) =>
                                        onFilterChange({
                                            ...filters,
                                            smsConsent: e.target.checked ? true : undefined,
                                            page: 1,
                                        })
                                    }
                                />
