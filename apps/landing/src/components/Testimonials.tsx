                ...
                <div className="max-w-2xl mx-auto text-center mb-10">
                    ...
                    >
                        {Array.from({ length: stars }).map((_, i) => (
                            <svg key={i} className="w-4 h-4" aria-hidden="true" fill="#b8bcc8" viewBox="0 0 20 20">
                ...
                <div className="flex justify-center gap-2">
                    {testimonials.map((t, i) => (
                        <button
                            ...
                            className="focus:outline-none focus:ring-2 focus:ring-[#b8bcc8]"
                            style={{
                                width: i === active ? '36px' : '8px',
                                height: '6px',
                                borderRadius: '3px',
                                background: i === active ? '#b8bcc8' : 'rgba(255,255,255,0.2)',
