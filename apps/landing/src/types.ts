...
export type AppointmentStatus = 'scheduled' | 'confirmed' | 'in_progress' | 'cancelled' | 'completed' | 'no_show';
...
export type TimeBlockType = 'break' | 'vacation' | 'training' | 'sick' | 'other';
...
export type NoteType = 'general' | 'warning' | 'preference' | 'medical' | 'payment';
...
export type MovementType = 'delivery' | 'sale' | 'stocktaking' | 'adjustment' | 'return';
...
export type ExceptionType = 'day_off' | 'vacation' | 'sick_leave' | 'training' | 'custom_hours' | 'other';
...
// Newsletter types
export type NewsletterStatus = 'draft' | 'scheduled' | 'sending' | 'sent' | 'partial_failure' | 'failed' | 'cancelled';
...
export type LoyaltyTransactionType = 'earn' | 'spend' | 'expire' | 'adjust' | 'bonus' | 'referral';
export type LoyaltyTransactionSource = 'appointment' | 'product_purchase' | 'reward' | 'birthday' | 'referral' | 'signup' | 'manual' | 'expiration';
export type RewardType = 'discount' | 'free_service' | 'free_product' | 'gift_card' | 'custom';
