...
const t = {
    pl: {
        ...
        hero: {
            ...
            tagline1: 'Zdrowe włosy to fundament. Styl — naturalny efekt.',
            tagline2: 'Odkryj, co naprawdę mogą Twoje włosy.',
        ...
        founder: {
            ...
            since: 'od 2011 roku',
            quote: 'Od wielu lat stale podnoszę swoje kwalifikacje oraz jakość moich usług, dzięki temu mam stałych zadowolonych klientów. Dołącz do nich — i przekonaj się, jak wyglądają naprawdę zdrowe włosy.',
        },
        history: {
        ...
        modal: {
            bookingServiceLabel: 'Rezerwacja usługi',
            loginTitle: 'Zaloguj się',
            bookingTitle: 'Umów wizytę',
            since: 'od 2011 roku',
            loginSub: 'aby przejść do kalendarza rezerwacji',
            alreadyLoggedIn: 'Jesteś już zalogowana/-y.',
            goToBooking: 'Przejdź do rezerwacji',
            emailLabel: 'Email',
        ...
        gallery: {
            ...
            lightboxShare: 'Udostępnij zdjęcie',
            lightboxDownload: 'Pobierz zdjęcie',
            lightboxHint: 'Przesuń lub użyj strzałek',
        },
        notFound: {
    ...
    en: {
        ...
        stats: [
            { suffix: '+', label: 'years of the salon' },
        ...
        founder: {
            ...
            since: 'since 2011',
            quote: 'For many years I have continually improved my qualifications and the quality of my services — which is why I have loyal, satisfied clients. Join them — and discover what truly healthy hair looks like.',
        },
        history: {
            eyebrow: 'Our roots',
            title: 'Our story',
        ...
        modal: {
            bookingServiceLabel: 'Service booking',
            loginTitle: 'Log in',
            bookingTitle: 'Book appointment',
            since: 'since 2011',
            loginSub: 'to access the booking calendar',
        ...
        gallery: {
            ...
            lightboxShare: 'Share image',
            lightboxDownload: 'Download image',
            lightboxHint: 'Swipe or use arrows',
        },
        notFound: {
    ...
    de: {
        ...
        founder: {
            ...
            since: 'seit 2011',
            quote: 'Seit vielen Jahren verbessere ich kontinuierlich meine Qualifikationen und die Qualität meiner Dienstleistungen — deshalb habe ich treue, zufriedene Kunden. Werden Sie Teil davon — und erleben Sie, wie wirklich gesundes Haar aussieht.',
        },
        history: {
        ...
        modal: {
            bookingServiceLabel: 'Leistungsbuchung',
            loginTitle: 'Anmelden',
            bookingTitle: 'Termin buchen',
            since: 'seit 2011',
            loginSub: 'um zum Buchungskalender zu gelangen',
            alreadyLoggedIn: 'Sie sind bereits angemeldet.',
            goToBooking: 'Zur Buchung',
            emailLabel: 'E-Mail',
        ...
        gallery: {
            ...
            lightboxShare: 'Bild teilen',
            lightboxDownload: 'Bild herunterladen',
            lightboxHint: 'Wischen oder Pfeiltasten verwenden',
        },
        notFound: {
            heading: 'Verlaufen?',
