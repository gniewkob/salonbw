...
export function useCustomers(filters: CustomerFilterParams = {}) {
    ...
    return useQuery<PaginatedCustomers>({
        ...
        queryFn: () => apiFetch<PaginatedCustomers>(`/customers?${queryString.toString()}`),
    });
}
...
export function useCustomerStatistics(customerId: number | null) {
    ...
    return useQuery<CustomerStatistics>({
        ...
        queryFn: () => apiFetch<CustomerStatistics>(`/customers/${customerId}/statistics`),
...
export function useCustomerNotes(customerId: number | null) {
    ...
    return useQuery<CustomerNote[]>({
        ...
        queryFn: () => apiFetch<CustomerNote[]>(`/customers/${customerId}/notes`),
        enabled: customerId !== null,
    });
}
...
export function useRemoveGroupMember() {
    ...
    return useMutation({
        mutationFn: ({
            ...
            apiFetch<void>(`/customer-groups/${groupId}/members/${customerId}`, {
                method: 'DELETE',
            }),
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: ['customer-groups'] });
