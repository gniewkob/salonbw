...
export default function SaleForm({
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (
            ...
            setError('Produkt jest wymagany');
            return;
        }

        if (!Number.isFinite(parsedData.quantity) || parsedData.quantity < 1) {
            setError('Ilość musi wynosić co najmniej 1');
            return;
        }
        ...
        if (
            ...
            setError('Cena jednostkowa musi być ≥ 0');
            return;
        }
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="gap-2">
            ...
            >
                ...
                {appointments.map((appointment) => (
                    ...
                    >
                        {appointment.client?.name ?? 'Nieznany klient'} ·{' '}
