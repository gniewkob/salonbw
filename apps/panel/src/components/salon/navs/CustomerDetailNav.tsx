// Sidebar navigation for customer detail page (KARTA KLIENTA)
// Matches styl source UI
...
interface CustomerDetailNavProps {
    customerId: number;
    customerName: string;
...
export default function CustomerDetailNav({
    customerId,
    customerName,
    customerGender,
    activeTab,
}: CustomerDetailNavProps) {
