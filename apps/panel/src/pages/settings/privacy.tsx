            ...
            <div className="salon-column-row">
                <div className="salon-column">
                    ...
                    <div className="border rounded p-3 mb-4">
                        <h3 className="h6 mb-2">Zgody i kanały kontaktu</h3>
                        <p className="text-muted small mb-0">
                            Preferencje powiadomień (panel, SMS, WhatsApp,
                            e-mail) każda osoba ustawia w swoim koncie — wysyłki
                            respektują wybrane kanały. Swoje zgody zmienisz w{' '}
                            <Link href="/account">
                                Moim koncie → Powiadomienia i zgody
                            </Link>
                            .
                        </p>
                    </div>
                    ...
                    <div className="border rounded p-3 text-muted small">
                        ...
                        <ul className="mb-0 ps-3">
                            <li>
                                <strong>Prawo dostępu</strong> — możesz zażądać
                                kopii swoich danych osobowych.
                            </li>
                            <li>
                                <strong>Prawo do sprostowania</strong> — możesz
                                poprosić o korektę nieprawidłowych danych.
                            </li>
                            <li>
                                <strong>Prawo do usunięcia</strong> — możesz
                                zażądać usunięcia swoich danych (prawo do bycia
                                zapomnianym).
                            </li>
                            <li>
                                <strong>Prawo do przenoszenia danych</strong> —
                                możesz zażądać przekazania danych w formacie
                                maszynoczytnym.
                            </li>
                        </ul>
                        <p className="mt-2 mb-0">
                            W celu realizacji powyższych praw skontaktuj się z
                            nami:{' '}
                            <a
