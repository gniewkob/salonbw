(() => {
    var e = {
            ...
            function expand(e) {
                ...
                for (const n in e.parsed) {
                    const r = Object.prototype.hasOwnProperty.call(t, n)
                        ? t[n]
                        : e.parsed[n];
                    e.parsed[n] = _resolveEscapeSequences(
                        _interpolate(r, t, e),
                    );
                }
                for (const n in e.parsed) {
        ...
        234: (e, t, n) => {
            ...
            function configDotenv(e) {
                ...
                try {
                    const o = l.parse(r.readFileSync(t, { encoding: n }));
                    let s = process.env;
                    if (e && e.processEnv != null) {
                        s = e.processEnv;
                    }
    ...
    (() => {
        __nccwpck_require__.d = (e, t) => {
            for (var n in t) {
                if (
                    __nccwpck_require__.o(t, n) &&
                    !__nccwpck_require__.o(e, n)
                ) {
    ...
    (() => {
            ...
            for (const o of e) {
                try {
                    ...
                    if (
                        ...
                        !_.some(
                            (e) =>
                                e.contents === o.contents && e.path === o.path,
                        )
                    ) {
                    ...
                    for (const t of Object.keys(e.parsed || {})) {
                        if (
                            typeof u[t] === 'undefined' &&
                            typeof l[t] === 'undefined'
                        ) {
                            u[t] =
                                (p = e.parsed) === null || p === void 0
                                    ? void 0
                                    : p[t];
                        }
                    }
                    ...
                    n.error(
                        `Failed to load env from ${r.join(t || '', o.path)}`,
                        e,
                    );
                }
            }
            return [Object.assign(process.env, u), u];
        }
        function resetEnv() {
            if (a) {
                replaceProcessEnv(a);
        ...
        function loadEnvConfig(t, n, o = console, s = false, i) {
            ...
            const d = c ? 'test' : n ? 'development' : 'production';
            const f = [
                `.env.${d}.local`,
                d !== 'test' && `.env.local`,
                `.env.${d}`,
