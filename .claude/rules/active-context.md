...
- Next: **Dzień 4 = E2E na prod** (rejestracja klientki → rezerwacja realnej usługi → pierwszy realny mail L2 → potwierdzenie w panelu → WhatsApp → finalizacja; scenariusz odrzucenia; konflikt podwójnej rezerwacji) + checklist odbioru z `docs/MVP_BOOKING_RUNBOOK.md`. Wymaga sprawdzenia konta pracowniczego Aleksandry (rola/przypisania) przed E2E.
