...
document.addEventListener('DOMContentLoaded', () => {
	...
	const calendar = new Calendar(calendarEl, {
		...
		dateClick(info) {
			...
			if (modal?.__x?.$data) {
				...
				console.warn('Modal adminCreateModal nie jest zainicjalizowany');
			}
		},

		/* -------- przeciągnięcie istniejącej wizyty -------- */
		eventDrop(info) {
	...
	calendar.render();
	window.calendar = calendar;   // przydatne w kodzie modala
});
