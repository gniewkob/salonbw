		...
		<form method="POST" action="{{ route('appointments.store') }}" class="space-y-6">
			@csrf
                        ...
                        <div x-show="variant_id" x-cloak>
                                ...
                                <div id="user-calendar" data-busy-url="{{ route('appointments.busy') }}" data-msg-url="{{ route('messages.create') }}" data-working-hours-url="{{ route('public.working-hours') }}" class="mb-4 h-96 border rounded"></div>
