export enum LogAction {
    ...
    SETTINGS_CALENDAR_VIEW_CREATED = 'SETTINGS_CALENDAR_VIEW_CREATED',
    SETTINGS_CALENDAR_VIEW_UPDATED = 'SETTINGS_CALENDAR_VIEW_UPDATED',
    SETTINGS_CALENDAR_VIEW_DELETED = 'SETTINGS_CALENDAR_VIEW_DELETED',
    SETTINGS_ONLINE_BOOKING_UPDATED = 'SETTINGS_ONLINE_BOOKING_UPDATED',
    SETTINGS_SMS_UPDATED = 'SETTINGS_SMS_UPDATED',
    SETTINGS_REMINDERS_UPDATED = 'SETTINGS_REMINDERS_UPDATED',
